Note that this repository is publicly available to the everyone in STA 418/518 as well as all of GitHub.
...
- Format your questions using markdown and code formatting.
  Better yet, create a [repex](https://reprex.tidyverse.org/) (reproducible example)
